...
function getOtpEmailHtml(code: string, userName: string): string {
  return `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
      ...
      <div style="padding: 40px; background: #f8fafc;">
        ...
        <p style="color: #475569; font-size: 16px; line-height: 1.7; margin: 0 0 25px;">
          You are signing a document on XYREG. Please use the verification code below to confirm your identity per FDA 21 CFR Part 11.
        </p>
        ...
        <div style="background: #fef3c7; border: 1px solid #fbbf24; border-radius: 8px; padding: 16px; margin: 25px 0;">
          <p style="color: #92400e; margin: 0; font-size: 14px; line-height: 1.6;">
            <strong>Important:</strong> This code is used to verify your identity for an electronic signature.
...
serve(async (req) => {
  ...
  try {
    ...
    if (action === "send") {
      ...
      const emailResponse = await fetch("https://api.resend.com/emails", {
        ...
        body: JSON.stringify({
          ...
          to: [email],
          subject: `Your E-Signature Verification Code: ${otpCode}`,
          html: getOtpEmailHtml(otpCode, userName),
        }),
      });
      ...
      console.log(`OTP sent to ${email} for e-signature verification`);
    ...
    console.error("Error in send-esign-otp:", error);
    return new Response(
