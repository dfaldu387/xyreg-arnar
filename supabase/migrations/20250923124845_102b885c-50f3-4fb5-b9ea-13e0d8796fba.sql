...
SELECT 
  'FDA_21_CFR_820',  -- Framework
  gti.clause_number,  -- Section
  gti.requirement_text,  -- Requirement
  gti.category,
  'not_applicable',  -- Use valid status value
  gti.clause_reference,  -- Clause ID
  gti.clause_description,  -- Clause Summary
  gti.chapter,
  gti.subsection,
