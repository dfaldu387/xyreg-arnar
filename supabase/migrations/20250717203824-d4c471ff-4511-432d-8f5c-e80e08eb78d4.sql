-- Fix the safe_reorder_company_phases function to avoid unique constraint violations
-- Instead of using -1 as temporary value, use max_position + offset approach
