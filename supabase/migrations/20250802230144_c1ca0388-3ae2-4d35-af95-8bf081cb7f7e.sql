-- Phase 2: Database Enhancements for Competitive Analysis Performance (Fixed)

-- Add GIN index on nomenclature_codes for fast EMDN code matching using array_ops
CREATE INDEX IF NOT EXISTS idx_eudamed_nomenclature_codes_gin 
ON eudamed_device_registry USING GIN (nomenclature_codes array_ops);
