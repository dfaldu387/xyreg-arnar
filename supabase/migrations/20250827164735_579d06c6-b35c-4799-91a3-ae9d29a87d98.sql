...
ADD CONSTRAINT unique_company_gap_item 
UNIQUE (framework, clause_id, requirement) 
WHERE product_id IS NULL;
...
ON CONFLICT (framework, clause_id, requirement) WHERE product_id IS NULL DO NOTHING;