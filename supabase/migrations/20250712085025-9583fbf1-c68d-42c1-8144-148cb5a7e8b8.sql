...
-- Add some example due dates to gap analysis items using milestone_due_date column
-- (30 days from now for high priority, 60 days for medium, 90 days for low)
UPDATE gap_analysis_items 
SET milestone_due_date = CASE 
...
END
WHERE milestone_due_date IS NULL;