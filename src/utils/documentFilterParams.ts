...
export function parseDocumentFiltersFromUrl(searchParams: URLSearchParams): Partial<DocumentFilters> {
  ...
  return {
    ...
    segmentPhase,
    segmentStatus,
    sortByDate: isValidSortOption(sortByDateRaw) ? sortByDateRaw : 'updated_newest',
...
export function serializeDocumentFiltersToUrl(
  ...
  return {
    ...
    [URL_PARAM_KEYS.SORT_BY_DATE]: filters.sortByDate && filters.sortByDate !== 'none' && filters.sortByDate !== 'updated_newest' ? filters.sortByDate : null,
