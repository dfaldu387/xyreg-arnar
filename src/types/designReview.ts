...
export const TECHNICAL_FILE_SECTIONS: TechnicalFileSection[] = [
  ...
  { id: 'TF-1', section: '1', label: 'Device Description & Specification', focus: 'Device variants, accessories, UDI-DI', legalReference: 'Annex II §1', description: 'Device description and specification including variants, accessories, and the UDI-DI per MDR Annex II Section 1.' },
  { id: 'TF-2', section: '2', label: 'Information Supplied by Manufacturer', focus: 'Labels, IFU, languages', legalReference: 'Annex II §2', description: 'Information supplied by the manufacturer including labels and instructions for use in all required languages per MDR Annex II Section 2.' },
  { id: 'TF-3', section: '3', label: 'Design & Manufacturing Information', focus: 'Drawings, processes, sites', legalReference: 'Annex II §3', description: 'Design and manufacturing information including drawings, process descriptions, and site information per MDR Annex II Section 3.' },
  { id: 'TF-4', section: '4', label: 'General Safety & Performance Requirements', focus: 'GSPR checklist, Annex I conformity', legalReference: 'Annex II §4', description: 'GSPR checklist demonstrating conformity with Annex I General Safety and Performance Requirements per MDR Annex II Section 4.' },
  { id: 'TF-5', section: '5', label: 'Benefit-Risk Analysis & Risk Management', focus: 'Risk management file, benefit-risk', legalReference: 'Annex II §5', description: 'Benefit-risk analysis and risk management file per Annex I requirements, as described in MDR Annex II Section 5.' },
  { id: 'TF-6', section: '6', label: 'Product Verification & Validation', focus: 'Pre-clinical, biocompatibility, CER', legalReference: 'Annex II §6', description: 'Product verification and validation data including pre-clinical data, biocompatibility, electrical safety, software validation, stability, performance testing, and the Clinical Evaluation Report per MDR Annex II Section 6.' },
