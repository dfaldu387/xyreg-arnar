...
import { chinaClassificationQuestions } from '@/data/chinaClassificationRules';

export function useChinaClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return chinaClassificationQuestions[session.currentQuestionId] || null;
