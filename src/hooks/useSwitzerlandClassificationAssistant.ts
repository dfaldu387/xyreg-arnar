...
import { switzerlandClassificationQuestions } from '@/data/switzerlandClassificationRules';

export function useSwitzerlandClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return switzerlandClassificationQuestions[session.currentQuestionId] || null;
