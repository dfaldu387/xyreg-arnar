...
import { japanClassificationQuestions } from '@/data/japanClassificationRules';

export function useJapanClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return japanClassificationQuestions[session.currentQuestionId] || null;
