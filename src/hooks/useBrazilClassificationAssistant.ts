...
import { brazilClassificationQuestions } from '@/data/brazilClassificationRules';

export function useBrazilClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return brazilClassificationQuestions[session.currentQuestionId] || null;
