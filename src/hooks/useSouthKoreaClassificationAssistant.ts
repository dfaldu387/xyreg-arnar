...
import { southKoreaClassificationQuestions } from '@/data/southKoreaClassificationRules';

export function useSouthKoreaClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return southKoreaClassificationQuestions[session.currentQuestionId] || null;
