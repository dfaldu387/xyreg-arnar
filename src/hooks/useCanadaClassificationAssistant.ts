...
import { canadaClassificationQuestions } from '@/data/canadaClassificationRules';

export function useCanadaClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return canadaClassificationQuestions[session.currentQuestionId] || null;
