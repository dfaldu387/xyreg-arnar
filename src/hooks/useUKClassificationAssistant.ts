...
import { ukClassificationQuestions } from '@/data/ukClassificationRules';

export function useUKClassificationAssistant() {
  ...
  const getCurrentQuestion = useCallback((): Question | null => {
    return ukClassificationQuestions[session.currentQuestionId] || null;
