...
import { useJapanIVDClassificationAssistant } from '@/hooks/useJapanIVDClassificationAssistant';
import { ClassificationResult } from '@/types/classification';

interface JapanIVDClassificationAssistantProps {
  isOpen: boolean;
  onClose: () => void;
  onComplete?: (classification: string, result: ClassificationResult) => void;
}

export function JapanIVDClassificationAssistant({
  isOpen,
  onClose,
  onComplete
}: JapanIVDClassificationAssistantProps) {
  const {
    session,
    currentQuestion,
    selectOption,
    ...
    canGoBack,
    isComplete
  } = useJapanIVDClassificationAssistant();
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className="flex items-center gap-2">
            ...
            Japan IVD Classification Assistant
          </DialogTitle>
          <DialogDescription>
            Determine the IVD classification based on PMDA/MHLW regulations (Classes I, II, III)
          </DialogDescription>
        </DialogHeader>
