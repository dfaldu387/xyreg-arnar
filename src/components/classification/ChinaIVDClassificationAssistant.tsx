...
import { useChinaIVDClassificationAssistant } from '@/hooks/useChinaIVDClassificationAssistant';
import { ClassificationResult } from '@/types/classification';

interface ChinaIVDClassificationAssistantProps {
  isOpen: boolean;
  onClose: () => void;
  onComplete?: (classification: string, result: ClassificationResult) => void;
}

export function ChinaIVDClassificationAssistant({
  isOpen,
  onClose,
  onComplete
}: ChinaIVDClassificationAssistantProps) {
  const {
    session,
    currentQuestion,
    selectOption,
    ...
    canGoBack,
    isComplete
  } = useChinaIVDClassificationAssistant();
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className="flex items-center gap-2">
            ...
            China IVD Classification Assistant
          </DialogTitle>
          <DialogDescription>
            Determine the IVD classification based on NMPA regulations (Classes I, II, III)
          </DialogDescription>
        </DialogHeader>
