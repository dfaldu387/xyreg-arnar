      ...
      menuItems: [
        ...
        // ── Purple: Regulatory & Compliance ──
        {
          ...
          children: [
            ...
            { id: 'ehds-data-vault', name: 'EHDS Data Vault', icon: <Database className="w-4 h-4" />, route: '/app/company/:companyName/ehds-data-vault' },
...
const menuItemTranslationKeys: Record<string, string> = {
  ...
  'ehds-data-vault': 'sidebar.menuItems.ehdsDataVault',
