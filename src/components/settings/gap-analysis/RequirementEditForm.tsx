...
interface RequirementEditFormProps {
  requirement: GapTemplateItemRow;
...
export function RequirementEditForm({
  ...
  const [formData, setFormData] = useState({
    ...
    is_applicable: requirement.is_applicable ?? true,
    applicability_rationale: requirement.applicability_rationale || '',
    guidance_text: requirement.guidance_text || '',
  ...
  const [evidenceMethods, setEvidenceMethods] = useState<Array<{
    ...
    Array.isArray(requirement.evidence_of_conformity) 
      ? (requirement.evidence_of_conformity as any[]).map((item, index) => ({
          id: `evidence-${index}`,
          method: item.method || '',
  ...
  const [applicableStandards, setApplicableStandards] = useState<string[]>(
    Array.isArray(requirement.applicable_standards) 
      ? requirement.applicable_standards as string[]
      : []
  );
