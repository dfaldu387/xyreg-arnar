...
interface PhasedDocumentManagerProps {
  phaseId: string;
  phaseName: string;
  company?: string;
  onClose?: () => void;
...
export function PhasedDocumentManager({ phaseId, phaseName, onClose }: PhasedDocumentManagerProps) {
  ...
  if (loading) {
    return (
      <Dialog open={true} onOpenChange={onClose}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Documents for {phaseName}</DialogTitle>
            <DialogDescription>
              Manage all documents assigned to this phase.
            </DialogDescription>
          </DialogHeader>
